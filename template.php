 ...
 * Page alter.
 */
function bootstrap_bryan_page_alter($page) {
 ...
 */
function bootstrap_bryan_preprocess_html(&$variables) {
	/**
	 * Add IE8 Support
	 */
	...
	*/
    ...
    if (theme_get_setting('bootstrap_css_cdn', 'bootstrap_bryan')) {
        $cdn = '//maxcdn.bootstrapcdn.com/bootstrap/' . theme_get_setting('bootstrap_css_cdn', 'bootstrap_bryan')  . '/css/bootstrap.min.css';
        drupal_add_css($cdn, array('type' => 'external'));
    }
    
    if (theme_get_setting('bootstrap_js_cdn', 'bootstrap_bryan')) {
        $cdn = '//maxcdn.bootstrapcdn.com/bootstrap/' . theme_get_setting('bootstrap_js_cdn', 'bootstrap_bryan')  . '/js/bootstrap.min.js';
	...
	*/
	if (theme_get_setting('scrolltop_display', 'bootstrap_bryan')) {
 ...
 */
function bootstrap_bryan_process_html(&$vars) {
 ...
 */
function bootstrap_bryan_preprocess_page(&$vars) {
 ...
 */
function bootstrap_bryan_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function bootstrap_bryan_preprocess_block(&$variables) {
 ...
 */
function bootstrap_bryan_form_alter(&$form, &$form_state, $form_id) {
